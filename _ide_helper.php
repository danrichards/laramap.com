 ...
 * Generated for Laravel 5.6.34 on 2018-08-27 10:51:24.
 *
...
namespace BeyondCode\Vouchers\Facades { 
    ...
    class Vouchers {
        ...
        {
            return \BeyondCode\Vouchers\Vouchers::generate($amount);
        }
        
        /**
         * 
         *
         * @param \BeyondCode\Vouchers\Model $model
         * @param int $amount
         * @param array $data
         ...
         * @static 
         */ 
        public static function create($model, $amount = 1, $data = array(), $expires_at = null)
        {
            return \BeyondCode\Vouchers\Vouchers::create($model, $amount, $data, $expires_at);
        }
         ...
         * @return \BeyondCode\Vouchers\Voucher 
         * @static 
         */ 
        public static function check($code)
        {
            return \BeyondCode\Vouchers\Vouchers::check($code);
        }
